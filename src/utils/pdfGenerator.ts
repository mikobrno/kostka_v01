...
import NotoSansRegular from './NotoSans-Regular-normal';
...
export const generateClientPDF = async (client: any, formData: any) => {
  ...
  const safeText = (text: string | undefined | null): string => {
    ...
    // Převod na UTF-8 kompatibilní formát je stále dobrý,
    // ale hlavní je nyní, že font podporuje tyto znaky
  ...
  autoTable(doc, {
    ...
    body: applicantData,
    theme: 'grid',
    headStyles: { fillColor: [66, 139, 202], font: 'NotoSans' }, // NASTAVTE FONT I ZDE
    margin: { left: 20, right: 20 },
    styles: {
      font: 'NotoSans', // NASTAVTE FONT I ZDE
      fontSize: 9,
      cellPadding: 3,
